...
public class RateLimiterTest {
    ...
    void testRateLimiter() {
        RateLimiter rateLimiter = RateLimiter.ofDefaults("wanda");
    ...
    void testRateLimiterConfig() {
        RateLimiterConfig config = RateLimiterConfig.custom()
                ...
                .build();
        RateLimiter rateLimiter = RateLimiter.of("wanda",config);
    ...
    void testRateLimiterRegistry() {
        ...
        RateLimiter rateLimiter = registry.rateLimiter("wanda","config");
